...
export class ListService {
  ...
  getUsers(): Observable<ListJsModel[]> {
    return this.http.get<ListJsModel[]>(`${this.apiUrl}`);
  }

  addUser(user: ListJsModel): Observable<ListJsModel> {
    return this.http.post<ListJsModel>(`${this.apiUrl}/Registre`, user);
  }

  updateUser(id: any, user: ListJsModel): Observable<ListJsModel> {
    return this.http.put<ListJsModel>(`${this.apiUrl}/${id}`, user);
  }
